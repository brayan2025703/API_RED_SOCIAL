...
import { ResponseHelper } from 'src/common/helpers/responde.helpers';
...
export class RolesService {
    ...
    /**
     * consulta roles eliminados logica
     */
    ...
    async update(id:string, dto:UpdateRoleDto){
        const role= await this.roleModel.findById(id);
        if(!role){
            throw new NotFoundException('ROl no Encontado');
        }
